...
const CheckoutButton = dynamic(
  () =>
    import("@clerk/nextjs/experimental").then(
      (module) => module.CheckoutButton
    ),
  { ssr: false }
);
...
const HAS_VALID_PLAN_ID = CLERK_PRO_PLAN_ID.startsWith("cplan_");
        ...
        <Card className="relative border-2 border-orange-600 bg-orange-50">
          ...
          <CardFooter>
            <SignedIn>
              ...
              ) : CLERK_BILLING_ENABLED && HAS_VALID_PLAN_ID ? (
                <CheckoutButton
